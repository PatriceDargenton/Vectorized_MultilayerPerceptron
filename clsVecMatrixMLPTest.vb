...
Namespace VectorizedMatrixMLP
    ...
    Public Class clsVecMatrixMLPTest
        ...
        Public Sub VectorizedMatrixMLP3XORDbleThreshold()
            ...
            m_mlp.WeightInit(0, {
                {0.4, 0.66, 0.95, 0.65, 0.84, 0.5, 0.07},
                {0.76, 0.34, 0.8, 0.27, 0.62, 0.18, 0.57},
                {0.96, 0.79, 0.73, 0.43, 0.56, 1.0, 0.67},
                {0.4, 0.52, 0.77, 0.61, 0.61, 0.65, 0.14},
                {0.99, 0.69, 0.87, 0.95, 0.9, 0.81, 0.75},
                {0.56, 0.94, 0.31, 0.48, 0.22, 0.86, 0.68},
                {0.66, 0.61, 0.35, 0.42, 0.63, 0.74, 0.28}})
            m_mlp.WeightInit(1, {
                {0.64, 0.26, 0.28},
                {0.1, 0.68, 0.34},
                {0.15, 0.17, 0.04},
